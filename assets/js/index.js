...
/* Import all componenets and functions */
...
*/
    ...
    fetchDataFromServer(`https://api.themoviedb.org/3/genre/movie/list?api_key=${api_key}`, function ({ genres }) {
        ...
        fetchDataFromServer(`https://api.themoviedb.org/3/trending/movie/day?api_key=${api_key}&page=1`, heroBanner);
    });
        ...
        sliderItem.innerHTML = `
                    ...
                    <div class="banner-content">
                        ...
                        <div class="meta-list">
                            ...
                            <div class="meta-item card-badge">${vote_average.toFixed(1)}5</div>
                        </div>
